...
/*
	...
	Modified and Extended in 2009 by
	
	    Kulikov Alexey <a.kulikov@gmail.com>
	    Leprouser 180 / clops
	    Ololo!
...
TimetrackService.prototype = {
	...
	tic: function (refresh) {
		...
		if (location != this.strActiveLocation) {
            ...
            //leproeffect here. inverse the functionality			
		    this.boolInWorkSite = !this.boolInWorkSite;
		}
	...
	loadDynamicProperties: function () {
		...
		var prefSites = this.branch.getCharPref (TIMETRACK_PREF_WORKSITEs);
